...
<details>
<summary><b>🔬 "Bucket 이미지", "다중 파장"이 뭔가요?</b></summary>

이 프로젝트의 주요 응용 분야 중 하나는 **위상 천이 간섭법(Phase Shifting Interferometry)**을 이용한 3D 표면 높이 복원입니다!

레이저 간섭 패턴으로 나노미터 단위의 높이를 측정하는 기술로, 반도체 웨이퍼 검사, 광학 부품 품질 관리 등에 사용됩니다.
